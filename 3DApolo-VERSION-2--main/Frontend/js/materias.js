...
function toast(msg, tipo='ok') {
  ...
  async function cargarCatalogos() {
    ...
    (d.proveedores||[]).forEach(p=>{const o=document.createElement('option');o.value=p.id_proveedor;o.textContent=p.nombre;sp.appendChild(o);});
  }
  ...
  async function guardar(e){
    ...
    const body={
      ...
      id_proveedor: document.getElementById('f-prov').value||null,
      stock:        document.getElementById('f-stock').value,
      stock_min:    document.getElementById('f-stock-min').value,
      costo_prom:   document.getElementById('f-costo').value,
    };
